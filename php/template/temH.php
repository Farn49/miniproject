    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: rgb(153, 0, 0);">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../basic/temH.php">
                    <i class="fas fa-home"></i>
                    <span> หัวหน้าหน่วย</span></a>
            </li>
            <!-- Divider -->
            ...
            <!-- Nav Item - Pages Collapse Menu จัดการข้อมูลพื้นฐาน -->
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#"><i class="fas fa-torii-gate"></i> จัดการข้อมูลหน่วยงาน</a>
                        <a class="collapse-item" href="#"><i class="fas fa-user-tie"></i> จัดการข้อมูลอาสากู้ภัย</a>
                        <a class="collapse-item" href="#"><i class="fas fa-book-medical"></i> จัดการข้อมูลหลักสูตร</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    ...
                    <span> พิจารณาผลอาสากู้ภัย</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <i class="fas fa-star"></i>
                    <span> บันทึกความเชี่ยวชาญพิเศษ</span>
                </a>
            </li>
            <!-- Nav Item - Utilities Collapse Menu จัดการตารางการปฏิบัติงาน-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-calendar-alt"></i>
                    <span>จัดการตารางการปฏิบัติงาน</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#"><i class="fas fa-plus"></i> ข้อมูล<br>กิจกรรมการปฏิบัติงาน</a>
                        <a class="collapse-item" href="#"><i class="fas fa-calendar-alt"></i> จัดตารางการปฏิบัติงาน</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu รายงาน-->
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">รายงานตามเงื่อนไข :</h6>
                        ...
                        <a class="collapse-item" href="#"><i class="fas fa-file-alt"></i> ข้อมูลกำหนดการหลักสูตร</a>
                        ...
                        <a class="collapse-item" href="#"><i class="fas fa-file-alt"></i> ข้อมูล<br>ผลการพิจารณาอาสากู้ภัย</a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="../basic/profile.php">
                ...
                <div class="card shadow mb-4 " style=" margin:20px;">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold ">หัวข้อ</h6>
                    </div>
                    <div class="card-body">
                        <!-- เริ่ม -->
                ...
                <!-- Begin Page Content เนื้อหาสิ้นสุด-->
            </div>
            <!-- Main Content -->
        </div>
        <!-- Content Wrapper -->
